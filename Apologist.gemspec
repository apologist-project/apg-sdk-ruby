...
Gem::Specification.new do |spec|
  ...
  spec.version = Apologist::VERSION
  spec.summary = "Ruby client library for the Apologist API"
  spec.description = "The Apologist Ruby library provides convenient access to the Apologist API from Ruby."
