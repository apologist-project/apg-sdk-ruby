    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { Apologist::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { Apologist::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            Apologist::FilePart.new(value)
          in Apologist::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in Apologist::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [Apologist::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: Apologist::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in Apologist::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in Apologist::Internal::Type::Converter
              ...
              Apologist::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(Apologist::Internal::Type::Converter, T::Class[T.anything]) }
        end
