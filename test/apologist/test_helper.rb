...
class Apologist::Test::SingletonClient < Apologist::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: Apologist::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class Apologist::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @apologist = Apologist::Test::SingletonClient.instance
  end
