...
require_relative "lib/apologist-ai/version"
...
Gem::Specification.new do |spec|
  spec.name = "apologist"
  spec.authors = ["Apologist-ai"]
  spec.version = Apologist-ai::VERSION
  spec.summary = "Ruby client library for the Apologist-ai API"
  spec.description = "The Apologist-ai Ruby library provides convenient access to the Apologist-ai API from Ruby."
