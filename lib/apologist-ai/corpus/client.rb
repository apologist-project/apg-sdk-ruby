...
module Apologist-ai
  module Corpus
    class Client
      ...
      # @param params [Apologist-ai::Corpus::Types::CorpusSearchRequest]
      ...
      #
      # @return [Apologist-ai::Corpus::Types::SearchCorpusResponse]
      def search_corpus(request_options: {}, **params)
        ...
        request = Apologist-ai::Internal::JSON::Request.new(
          ...
          method: "POST",
          path: "corpus/search",
          body: Apologist-ai::Corpus::Types::CorpusSearchRequest.new(params).to_h,
        ...
        if code.between?(200, 299)
          Apologist-ai::Corpus::Types::SearchCorpusResponse.load(response.body)
        else
      ...
      #
      # @param request_options [Hash]
      # @param params [Apologist-ai::Corpus::Types::ViewRequest]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      ...
      def log_corpus_view(request_options: {}, **params)
        params = Apologist-ai::Internal::Types::Utils.normalize_keys(params)
        request_data = Apologist-ai::Corpus::Types::ViewRequest.new(params).to_h
      ...
      #
      # @param request_options [Hash]
      # @param params [Apologist-ai::Corpus::Types::ImpressionRequest]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      ...
      def log_corpus_impression(request_options: {}, **params)
        params = Apologist-ai::Internal::Types::Utils.normalize_keys(params)
        request_data = Apologist-ai::Corpus::Types::ImpressionRequest.new(params).to_h
        non_body_param_names = %w[model id]
        body = request_data.except(*non_body_param_names)
      ...
      #
      # @param request_options [Hash]
      # @param params [Apologist-ai::Corpus::Types::ReferralRequest]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      ...
      def log_corpus_referral(request_options: {}, **params)
        params = Apologist-ai::Internal::Types::Utils.normalize_keys(params)
        request_data = Apologist-ai::Corpus::Types::ReferralRequest.new(params).to_h
        non_body_param_names = %w[model id]
        body = request_data.except(*non_body_param_names)
