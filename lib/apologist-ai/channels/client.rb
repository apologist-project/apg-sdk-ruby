...
module Apologist-ai
  module Channels
    class Client
      ...
      #
      # @return [Apologist-ai::Channels::Types::GetDiscordChannelStatusResponse]
      def get_discord_channel_status(request_options: {}, **params)
        ...
        if code.between?(200, 299)
          Apologist-ai::Channels::Types::GetDiscordChannelStatusResponse.load(response.body)
        else
      ...
      # @option request_options [Integer] :timeout_in_seconds
      # @option params [String] :id
      # @option params [Apologist-ai::Channels::Types::VerifyFacebookWebhookRequestHubMode] :hub_mode
      ...
      #
      # @param request_options [Hash]
      # @param params [Apologist-ai::Channels::Types::ReceiveTwilioMessageRequest]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      ...
      def receive_twilio_message(request_options: {}, **params)
        params = Apologist-ai::Internal::Types::Utils.normalize_keys(params)
        request_data = Apologist-ai::Channels::Types::ReceiveTwilioMessageRequest.new(params).to_h
        non_body_param_names = %w[id]
        body = request_data.except(*non_body_param_names)

        request = Apologist-ai::Internal::UrlEncoded::Request.new(
          base_url: request_options[:base_url],
          method: "POST",
