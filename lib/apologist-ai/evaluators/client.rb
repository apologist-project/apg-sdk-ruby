...
module Apologist-ai
  module Evaluators
    class Client
      ...
      #
      # @return [Apologist-ai::Evaluators::Types::ListEvaluationsResponse]
      def list_evaluations(request_options: {}, **params)
        ...
        if code.between?(200, 299)
          Apologist-ai::Evaluators::Types::ListEvaluationsResponse.load(response.body)
        else
      ...
      #
      # @param request_options [Hash]
      # @param params [Apologist-ai::Evaluators::Types::EvaluatorRequest]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      ...
      #   )
      #
      # @return [Apologist-ai::Evaluators::Types::EvaluateContentResponse]
      def evaluate_content(request_options: {}, **params)
        params = Apologist-ai::Internal::Types::Utils.normalize_keys(params)
        request_data = Apologist-ai::Evaluators::Types::EvaluatorRequest.new(params).to_h
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          Apologist-ai::Evaluators::Types::EvaluateContentResponse.load(response.body)
        else
          error_class = Apologist-ai::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      #   )
      #
      # @return [Apologist-ai::Evaluators::Types::GetEvaluationResponse]
      def get_evaluation(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          Apologist-ai::Evaluators::Types::GetEvaluationResponse.load(response.body)
        else
          error_class = Apologist-ai::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
