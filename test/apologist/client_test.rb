...
class ApologistTest < Minitest::Test
  ...
  def test_client_default_request_default_retry_attempts
    ...
    apologist = Apologist::Client.new(base_url: "http://localhost", api_key: "My API Key")

    assert_raises(Apologist::Errors::InternalServerError) do
  ...
  def test_client_given_request_default_retry_attempts
    ...
    apologist = Apologist::Client.new(base_url: "http://localhost", api_key: "My API Key", max_retries: 3)
  ...
  def test_client_default_request_given_retry_attempts
    ...
    assert_raises(Apologist::Errors::InternalServerError) do
      apologist.pet.update(name: "doggie", photo_urls: ["string"], request_options: {max_retries: 3})
    end
  ...
  def test_client_given_request_given_retry_attempts
    ...
    assert_raises(Apologist::Errors::InternalServerError) do
      apologist.pet.update(name: "doggie", photo_urls: ["string"], request_options: {max_retries: 4})
    end
  ...
  def test_client_retry_after_seconds
    ...
    apologist = Apologist::Client.new(base_url: "http://localhost", api_key: "My API Key", max_retries: 1)
  ...
  def test_client_redirect_307
    ...
    assert_raises(Apologist::Errors::APIConnectionError) do
      apologist.pet.update(name: "doggie", photo_urls: ["string"], request_options: {extra_headers: {}})
    end

    recorded, = WebMock::RequestRegistry.instance.requested_signatures.hash.first

    assert_requested(:any, "http://localhost/redirected", times: Apologist::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_303
    ...
    assert_requested(:get, "http://localhost/redirected", times: Apologist::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_auth_strip_cross_origin
    ...
    assert_requested(:any, "https://example.com/redirected", times: Apologist::Client::MAX_REDIRECTS) do
      headers = _1.headers.keys.map(&:downcase)
