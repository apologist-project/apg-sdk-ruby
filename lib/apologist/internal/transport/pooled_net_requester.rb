      ...
      class PooledNetRequester
        ...
        class << self
          ...
          def calibrate_socket_timeout(conn, deadline)
            timeout = deadline - Apologist::Internal::Util.monotonic_secs
          ...
          def build_request(request, &blk)
            ...
            in String
              ...
              req.body_stream = Apologist::Internal::Util::ReadIOAdapter.new(body, &blk)
            in StringIO
        ...
        private def with_pool(url, deadline:, &blk)
          origin = Apologist::Internal::Util.uri_origin(url)
          timeout = deadline - Apologist::Internal::Util.monotonic_secs
          pool =
        ...
        def execute(request)
          ...
          enum = Enumerator.new do |y|
            ...
            raise Apologist::Errors::APITimeoutError.new(url: url, request: req)
          rescue StandardError
            raise Apologist::Errors::APIConnectionError.new(url: url, request: req)
          end
          # rubocop:enable Metrics/BlockLength

          _, response = enum.next
          body = Apologist::Internal::Util.fused_enum(enum, external: true) do
            finished = true
            loop { enum.next }
          end
