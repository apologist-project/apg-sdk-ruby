...
class Apologist::Test::PrimitiveModelTest < Minitest::Test
  A = Apologist::Internal::Type::ArrayOf[-> { Integer }]
  H = Apologist::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  module U
    extend Apologist::Internal::Type::Union
  end

  class B < Apologist::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      Apologist::Internal::Type::Unknown,
      Apologist::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Apologist::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Apologist::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Apologist::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Apologist::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = Apologist::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        Apologist::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Apologist::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Apologist::Internal::Type::Boolean, true] => true,
      [Apologist::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Apologist::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Apologist::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Apologist::Internal::Type::Converter.new_coerce_state
      Apologist::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Apologist::Internal::Type::Converter.dump(target, input, state: state)
...
class Apologist::Test::EnumModelTest < Minitest::Test
  class E0
    include Apologist::Internal::Type::Enum
...
class Apologist::Test::CollectionModelTest < Minitest::Test
  A1 = Apologist::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Apologist::Internal::Type::HashOf[Integer]

  A2 = Apologist::Internal::Type::ArrayOf[H1]
  H2 = Apologist::Internal::Type::HashOf[-> { A1 }]

  A3 = Apologist::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Apologist::Internal::Type::HashOf[Integer, nil?: true]
...
class Apologist::Test::BaseModelTest < Minitest::Test
  class M1 < Apologist::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Apologist::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Apologist::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Apologist::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Apologist::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Apologist::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Apologist::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Apologist::Errors::ConversionError => e
...
class Apologist::Test::UnionTest < Minitest::Test
  class U0
    include Apologist::Internal::Type::Union
  ...
  class M2 < Apologist::Internal::Type::BaseModel
  ...
  class M4 < Apologist::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Apologist::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Apologist::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Apologist::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Apologist::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include Apologist::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [Apologist::Internal::Type::Unknown, Apologist::Internal::Type::Unknown] => true,
      [Apologist::Internal::Type::Boolean, Apologist::Internal::Type::Boolean] => true,
      [Apologist::Internal::Type::Unknown, Apologist::Internal::Type::Boolean] => false,
...
class Apologist::Test::MetaInfoTest < Minitest::Test
  A1 = Apologist::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Apologist::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
