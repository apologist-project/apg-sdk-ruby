...
Most of the SDK is generated code. Modifications to code will be persisted between generations, but may result in merge conflicts between manual patches and changes from the generator. The generator will never modify the contents of `lib/apologist/helpers/` and `examples/` directory.
...
require_relative "../lib/apologist"
...
```ruby
gem "apologist", git: "https://www.github.com/apologist-project/apg-sdk-ruby"
```

Alternatively, reference local copy of the repo:

```bash
$ git clone -- 'https://www.github.com/apologist-project/apg-sdk-ruby' '<path-to-repo>'
```

```ruby
gem "apologist", path: "<path-to-repo>"
```
